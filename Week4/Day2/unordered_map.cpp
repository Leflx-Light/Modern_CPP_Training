...
void CreateObjects(std::unordered_map<K,V>&mapData){
    mapData.emplace(101, Employee("Harshit", 45654,"Trainer", 10));
    mapData.emplace(102, Employee("Harshit", 45654,"Trainer", 10));
    mapData.emplace(103, Employee("Harshit", 45654,"Trainer", 10));
